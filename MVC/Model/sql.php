...
class SentenciasSQLManager {
    ...
    public function mostrarUpdateDatos(){
        try {
    ...
    public function sqlUpdateDatos(){
        try {
    ...
    public function administradorUpdateNfc(){
        try {
            $sqlUpdate = "UPDATE Usuario u 
            JOIN administrador a ON a.rut_administrador = u.rut_administrador 
            SET u.admin_prepara_nfc = FAlSE,
                u.admin_prepara_nfc_update = 
                CASE 
                    WHEN u.prepara_Nfc = TRUE AND a.nfc_administrador = :nfcAdmin THEN TRUE
                    WHEN u.prepara_Nfc = FALSE AND a.nfc_administrador = :nfcAdmin THEN FALSE
                END
    ...
    public function leerNfcNuevaIngresada(){
        try {
            $sqlUpdate = "SELECT 
                CASE 
    ...
    public function obtenerTimeNfc(){
        try {
    ...
    public function leerNfcNuevaIngresadaUpdate(){
        try {
            $sqlUpdate = "SELECT updated_at_usuario from Usuario Where rut_usuario = :rut_usuario
                                                                AND rut_administrador = :rut_administrador
                                                                AND prepara_nfc = TRUE
    ...
    public function borrarUsuarioSQL() {
        try {
    ...
    public function recuperarUsuarioEliminadoSql() {
        try {
    ...
    public function sqlregistrarDatos(){
        try {
    ...
    public function preparaNFC(){
        try {
            $preparaNFC = "UPDATE Usuario u
            SET u.admin_prepara_nfc = FALSE,
                u.admin_prepara_nfc_update = FALSE,
                u.prepara_nfc = CASE 
